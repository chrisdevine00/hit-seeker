...
export const SLOT_BADGES = [
  ...
  { id: 'photo-evidence', name: 'Photo Evidence', description: 'Add first photo to a spot', category: 'quick-win', domain: 'slot', icon: 'camera', color: 'blue', effect: 'confetti', tier: 'common' },
  ...
  // Photo (2)
  { id: 'photographer', name: 'Photographer', description: 'Add photos to 20 spots', category: 'photo', domain: 'slot', icon: 'camera', color: 'blue', effect: 'explode', tier: 'rare' },
  { id: 'multi-photo', name: 'Multi-Photo', description: 'Add 3+ photos to single spot', category: 'photo', domain: 'slot', icon: 'images', color: 'purple', effect: 'explode', tier: 'epic' },
];
